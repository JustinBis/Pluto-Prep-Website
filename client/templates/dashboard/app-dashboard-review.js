Template.appDashboardReview.helpers({

	sortAll: function() {
		if (Session.get("sortby") === "all") {
			return true;
		}
		return false;
	},
	...
	sortCorrect: function() {
		if (Session.get("sortby") === "correct") {
			console.log("sort by correct man");
			return true;
		}
		return false;
	},

	sortIncorrect: function() {
		if (Session.get("sortby") === "incorrect") {
			return true;
		}
		return false;
	},
...
// Dashboard Review event listeners
Template.appDashboardReview.events({
	'click #all-ques': function() {
		Session.set('sortby', "all");
	},
	'click #cor-ques': function() {
		Session.set('sortby', "correct");
	},
	'click #inc-ques': function() {
		Session.set('sortby', "incorrect");
	}
});