...
Router.route('/dashboard', {
	...
	// waitOn : function () {
 //        return Meteor.subscribe('myQuestionTracker');
 //    },
 //    data: function() {
	// 	return QuestionTracker.find({});
	// },
})
...
// TODO: Make sure admin routes are only run for those that have access
/*
Router.onBeforeAction(function(){
	// If this user is not an admin, show a 404 page
	if(!(Meteor.user()['admin']))
	{
		this.render('app-not-found');
	}
	else
	{
		// Otherwise keep going with the route
	...
	// Only run this hook for these routes (should be all admin routes)
	'admin-home',
	'admin-question-edit',
